...
static int single_int(int q,void *p) {
...
static int single_char(int q,void *p) {
...
static int single_float(int q,void *p) {
...
static int single_double(int q,void *p) {
...
static int single_mpi_type(int arg1, void *arg2) {
    long double temp;
...
static void test2e(void) {
    ...
    CU_ASSERT_DOUBLE_EQUAL((double)back, (double)echo, 0.0000000001);
}
