...
static int gather_write(int q, void *p) {
...
static int gather_array_write(int idx, void* arg2)
{
    int i;
    int len = 10001;
...
static int test7c_writer(int proc_id, void* arg2)
{
    int ints[5];
    int i;
    for (i = 0; i < 5; i++)
...
static int nonmain_gatherer(int arg1, void* arg2)
{
    int ints[10] = {0};
    int i, success = 1;
